...
You can manually install a VS Code extension, by getting the source code, and put it into your respective install directory in the naming format of "user.extension-1.0". VS Code will detect and load the extension on launch.
...
* [VS Code Quickstart](/docs/editing/getting-started.md): discover the key features of VS Code with a step-by-step guide.
